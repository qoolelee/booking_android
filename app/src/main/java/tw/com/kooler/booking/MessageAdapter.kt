...
class MessageAdapter(private val messages: MutableList<Message>) :
    ...
    class MessageViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val imageRoomContainer: LinearLayout = itemView.findViewById(R.id.imageRoomContainer)
        val imageRoomLeft: ImageView = itemView.findViewById(R.id.imageRoomLeft)
    ...
    override fun onBindViewHolder(holder: MessageViewHolder, position: Int) {
        ...
        if (message.isUser) {
            ...
            holder.imageRoomContainer.visibility = View.GONE
            holder.imageRoomLeft.visibility = View.GONE
            ...
            if (message.isLoading) {
                ...
                if (message.imageUrl != null) {
                    // image
                    holder.imageRoomContainer.visibility = View.VISIBLE
                    holder.imageRoomLeft.visibility = View.VISIBLE

                    Glide.with(holder.itemView.context)
                        .load(message.imageUrl)
                        .placeholder(android.R.drawable.ic_menu_report_image)
                        .error(android.R.drawable.stat_notify_error)
                        .into(holder.imageRoomLeft)
                } else {
